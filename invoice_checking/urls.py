...
urlpatterns = [
    ...
    url(r'^weekly_report/(?P<weekly_report_id>[0-9A-Fa-f-]+)/comments/(?P<weekly_report_comment_id>[0-9A-Fa-f-]+)?/delete$', invoices.views.delete_weekly_report_summary, name="delete_weekly_report_summary"),
