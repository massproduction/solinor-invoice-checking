...
urlpatterns = [
    ...
    url(r'^weekly_report/(?P<weekly_report_id>[0-9A-Fa-f-]+)/hours_pdf$', invoices.views.get_pdf, name="get_weekly_hours_pdf"),
    url(r'^weekly_report/(?P<weekly_report_id>[0-9A-Fa-f-]+)/pdf$', invoices.views.get_weekly_report_pdf, name="get_weekly_report_pdf"),
